# AquaBrain Software Controller - Revit 2025
# Usage: .\revit2025.ps1 -Action <open|close|status>
...
$SOFTWARE_NAME = "Revit 2025"
$PROCESS_NAME = "Revit"
$EXE_PATH = "C:\Program Files\Autodesk\Revit 2025\Revit.exe"
$VERSION_CHECK = "2025"
